...
//        Process p = builder.start();
        ...
        //ffmpeg的路径
        String ffmpeg_path = "E:\\workspace\\env\\ffmpeg\\ffmpeg-master-latest-win64-gpl\\bin\\ffmpeg.exe";
        //源avi视频的路径
        String video_path = "C:\\Users\\26659\\Desktop\\test\\a1.mp4";
        //转换后mp4文件的名称
        String mp4_name = "m1.avi";
        //转换后mp4文件的路径
        String mp4_path = "C:\\Users\\26659\\Desktop\\test\\m1.avi";
        //创建工具类对象
